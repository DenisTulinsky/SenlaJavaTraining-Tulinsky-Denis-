 ...
 */
@PrintableObject(name = "Storage")
public class Storage implements IStorage, Serializable {

	
	private static final long serialVersionUID = 1L;
	
	@PrintableRef(name = "booksList",isDetailedView = false,order = 1)
	private ArrayList<IBook> books;
	@PrintableRef(name = "preordersList",isDetailedView = false,order = 2)
	private ArrayList<IPreorder> preorders;
	@PrintableRef(name = "ordersList",isDetailedView = false,order = 3)
