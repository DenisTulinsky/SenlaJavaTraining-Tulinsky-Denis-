...
public class OrderService implements IOrderService {
	...
	@Override
	public synchronized void addOrder(IOrder order, String title) {
	...
	@Override
	public synchronized void executeOrder(String booktitle, String customer) {
	...
	@Override
	public synchronized void cancelOrder(String booktitle, String customer) {
		List<IOrder> orders = storage.getAllOrders();
		try {
			for (IOrder ord : orders) {
				if (ord != null && ord.getBook().getTitle().equals(booktitle) && ord.getCustomer().equals(customer)) {
	...
	@Override
	public synchronized List<String> viewOrderDetail(String bookstitle, String customer) {
		List<IOrder> allOrders = storage.getAllOrders();
		List<String> result = new ArrayList<>();
		try{
		for (IOrder ord : allOrders) {
