...
public class Converter implements IConverter {
	...
	public String bookToString(IBook book) {
		String str = new StringBuilder().append(book.getId()).append(",").append(book.getTitle()).append(",").append(book.getAuthor()).append(",")
	...
	public String orderToString(IOrder order) {
		String str = new StringBuilder().append(order.getId()).append(",").append(order.getBook().getTitle()).append(",")
	...
	public String preorderToString(IPreorder preord) {
		String str = new StringBuilder().append(preord.getId()).append(",").append(preord.getTitle()).append(",").append(preord.getAuthor()).append(",")
				.append(preord.getStatus()).toString();
		return str;
	...
	public IPreorder stringToPreorder(String preorderstring) {
		...
		preorder.setStatus(Status.valueOf(str[3]));
		return preorder;
