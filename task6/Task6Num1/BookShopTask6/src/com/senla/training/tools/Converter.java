...
public class Converter implements IConverter {
	...
	public String bookToString(IBook book) {
		String str = new StringBuilder().append(book.getTitle()).append(",").append(book.getAuthor()).append(",")
				...
				.append(book.getDescription()).append(",").append(book.getId()).toString();
	...
	public IBook stringToBook(String bookstring) {
		...
		book.setInStock(Status.valueOf(str[3]));
		...
		book.setId(Integer.valueOf(str[7]));////
		return book;
	}
	...
	public String preorderToString(IPreorder preord) {
		String str = new StringBuilder().append(preord.getTitle()).append(",").append(preord.getAuthor()).append(",")
