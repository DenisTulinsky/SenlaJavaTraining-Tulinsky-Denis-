...
import com.senla.training.addidionalActions.Exit;
import com.senla.training.addidionalActions.Serialize;
...
public class MenuBuilder implements IMenuBuilder {
	...
	private static final String SERIALIZE_THE_DATA = "Serialize the Data";
	...
	public IMenu build() {
		...
		mainMenu.add(new Serialize(SERIALIZE_THE_DATA, 4));
		mainMenu.add(new Exit(EXIT, 5));
