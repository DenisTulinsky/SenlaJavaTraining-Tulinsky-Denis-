...
public class DI {
	...
	/**
	 * Checks if Checks if object of the Class<?> interface is in the map,
	 * returns object. If not in the map, goes to prop.configuration, finds
	 * corresponding class, instantiates a new object and puts it in the map.
	 *
	 * @param Class<T>
