...
public class OrderService implements IOrderService {
	...
	@Override
	public synchronized boolean executeOrder(Integer id) {
		Connection cn = ConnectorDB.getInstance().getConnection();
		return orderDao.updateStatus(cn, id, Status.EXECUTED.toString());
	}

	@Override
	public synchronized boolean cancelOrder(Integer id) {
		Connection cn = ConnectorDB.getInstance().getConnection();
	...
	public synchronized boolean cloneOrder(Integer id) throws SQLException {
		Connection cn = ConnectorDB.getInstance().getConnection();
		Boolean flag = false;
		try {
